...
const Restaurants = () => {
  ...
  <div className="overlay">
    <div className="text-overlay"><h1 className='display-1' style={{fontSize:'4vw'}}>Our Recommended Restaurants</h1><br></br><p style={{fontSize:'1.5vw'}}>
      ...
      <div className="card text-secondary img-hover-zoom">
        ...
        <div className="card-body text-start">
         ...
         <h6> <span className='text-warning fs-5'>{r.price}0tk</span> <small style={{textDecoration:'line-through'}}>1000tk</small></h6> </div>
          ...
          <div className='d-flex justify-content-between'><p style={{fontSize:'1.2vw'}}><span className='text-warning' style={{fontSize:'1.2vw'}}><FontAwesomeIcon icon={faStar}/><FontAwesomeIcon icon={faStar}/><FontAwesomeIcon icon={faStar}/><FontAwesomeIcon icon={faStar}/></span><FontAwesomeIcon icon={faStar}/></p>
          <small style={{fontSize:'1vw'}}>booked by {r.ppl}00 people</small></div>
        </div>
      </div>
    </div>
    )
